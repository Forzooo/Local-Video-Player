...
class App(customtkinter.CTk):
    def __init__(self):
        ...
        self.video_list_frame = VideoListFrame(master=self, width=900, command=self.delete_video, corner_radius=0)  # Create the frame of the video entered by the user
